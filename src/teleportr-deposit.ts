...
export function handleMaxBalanceSet(event: MaxBalanceSet): void {}

export function handleMaxDepositAmountSet(event: MaxDepositAmountSet): void {}

export function handleMinDepositAmountSet(event: MinDepositAmountSet): void {}
